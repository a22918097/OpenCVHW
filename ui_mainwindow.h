...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        image_label->setGeometry(QRect(410, 110, 691, 411));
        label_b = new QLabel(centralWidget);
        label_b->setObjectName(QStringLiteral("label_b"));
        label_b->setGeometry(QRect(20, 107, 71, 31));
        QFont font;
        ...
        horizontalSlider_bri->setGeometry(QRect(110, 115, 160, 22));
        ...
        pushButton_gs->setGeometry(QRect(20, 600, 81, 71));
        QFont font1;
        ...
        horizontalSlider_RED->setGeometry(QRect(110, 160, 160, 22));
        ...
        label->setGeometry(QRect(30, 154, 41, 31));
        label->setFont(font);
        ...
        horizontalSlider_GREEN->setGeometry(QRect(110, 210, 160, 22));
        ...
        horizontalSlider_BLUE->setGeometry(QRect(110, 260, 160, 22));
        ...
        label_2->setGeometry(QRect(30, 200, 51, 31));
        label_2->setFont(font);
        label_3 = new QLabel(centralWidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(30, 250, 51, 31));
        ...
        pushButton_blur->setGeometry(QRect(130, 600, 81, 71));
        pushButton_blur->setFont(font1);
        pushButton_save = new QPushButton(centralWidget);
        pushButton_save->setObjectName(QStringLiteral("pushButton_save"));
        pushButton_save->setGeometry(QRect(1000, 600, 101, 81));
        QFont font2;
        ...
        pushButton_NI->setEnabled(true);
        pushButton_NI->setGeometry(QRect(240, 600, 81, 71));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        image_label->setText(QApplication::translate("MainWindow", "TextLabel", 0));
